...
def get_clean_data():
    data_csv=Path(__file__).parents[5] / 'C:/Users/user/Docker/BreastCancer/data.csv'
...
def add_prediction(input_data):
    ...
    st.write("Probability of being Begnin: ", classifier.predict_proba(input_array)[0][0])
    st.write("Probability of being Malignent: ", classifier.predict_proba(input_array)[0][1])
...
def main():
    ...
    with st.container():
        ...
        st.write("Please connect this app to your cytology tab to help diagnose breast cancer from your tissue sample. This app predicts using a machine learning model whether a breast mass is bening or melignance based on the measurements it received from your cytosis lab. You can also update the measurement by hand using the sliders in the sidebar. ")
